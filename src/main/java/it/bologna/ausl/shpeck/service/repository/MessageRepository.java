...
public interface MessageRepository extends JpaRepository<Message, Integer> {
    ...
    @Query(value = "select cast (id as int) id from shpeck.messages where in_out = 'OUT' and message_status not in ('CONFIRMED', 'ACCEPTED') and update_time > (current_date - 1)", nativeQuery = true)
